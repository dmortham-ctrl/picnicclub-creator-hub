...
export default async function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="hero">
      <div><div className="eyebrow">Creator commerce ecosystem / 001</div><h1>{content.hero_title}</h1><p className="hero-copy">{content.hero_description}</p><div className="hero-actions"><TrackedLink ctaKey="join_creator" className="button-lime" href="/join">Join as creator ↗</TrackedLink><TrackedLink ctaKey="collaborate" className="button-outline" href="https://wa.me/62895364547187">Collaborate with us</TrackedLink></div></div>
    ...
    <section className="final-cta"><div className="eyebrow">Your next chapter / 008</div><h2>Ready to grow<br /><i>together?</i></h2><div className="hero-actions"><TrackedLink ctaKey="join_creator" className="button-lime" href="/join">Join as creator ↗</TrackedLink><TrackedLink ctaKey="collaborate" className="button-outline light-outline" href="https://wa.me/62895364547187">Work with us</TrackedLink></div></section>
