...
-- ---------------------------------------------------------------------------
-- Picnic Tools (AI hook / script generator)
-- ---------------------------------------------------------------------------
...
create policy "authenticated reads cache" on public.tool_cache for select to authenticated using (true);
create policy "authenticated writes cache" on public.tool_cache for insert to authenticated with check (true);
create policy "authenticated updates cache" on public.tool_cache for update to authenticated using (true) with check (true);
